<template>
  <div class="staffPayrollDetail">
    ...
    <el-row :gutter="12">
      ...
      <el-col :span="8">
        <el-card shadow="always">税后工资：{{details.grossPay}}</el-card>
      </el-col>
      <el-col :span="8">
        <el-card shadow="always">应纳税工资：{{details.taxAmount}}</el-card>
      </el-col>
      <el-col :span="8">
        <el-card shadow="always">税额：{{details.taxableWages}}</el-card>
      </el-col>
      <el-col :span="8">
        <el-card shadow="always">总金额：{{details.totalAmount}}</el-card>
      </el-col>
    </el-row>
