    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px">
      ...
      <el-form-item label="类型：" prop="typeId" v-if="isShow">
        <el-radio-group v-model="ruleForm.typeId">
          ...
          <el-radio label="3">工伤</el-radio>
          <el-radio label="4">生育</el-radio>
          <el-radio label="5">失业</el-radio>
...
export default {
  ...
  methods: {
    ...
    // 新增
    addFun() {
      var reqUrl = "/server/api/v1/bu/insuredScheme/si/add";
      var data = {
