<template>
  <div class="wrap region">
    ...
    <div class="my-top">
      <span>区域列表</span>
      <el-button type="warning" size="small" @click='isShowAddModule=true;curInfo.type="region"'>添加区域</el-button>
    </div>
    <!-- 列表内容 -->
    ...
    <!-- 新增区域 -->
    <el-dialog title="新增区域" :visible.sync="isShowAddModule" :close-on-click-modal="false" width="65%">
